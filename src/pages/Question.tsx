      ...
      <div className="question-page__content">
        ...
        >
          ...
          <div className="question-page__actions">
            <Button disabled={!selected || submitted} onClick={() => setSubmitted(true)}>
              {t('questionSubmit')}
            </Button>
            <Button
              variant="ghost"
            ...
            {submitted && nextQuestionId ? (
              <Button
                variant="secondary"
                onClick={() => navigate(getChapterQuestionPath(resolvedQuestion.chapterId, nextQuestionId))}
              >
                {t('questionNext')}
              </Button>
            ) : null}
